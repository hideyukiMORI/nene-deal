...
/**
 * NeNe Deal's branded browser error page for the public demo start route
 * (`Nene2\Demo` consumer, #69 — ported from invoice's #617 renderer).
 *
 ...
 * card in Deal's calm teal theme: brand header strip, reason callout, and —
 * for 429 — a live countdown that enables the retry button when the window
 * resets.
 *
...
{
    private const string SELF_HOST_URL = 'https://github.com/hideyukiMORI/nene-deal';
    ...
    private function html(int $status, int $retryAfter): string
    {
        ...
        return <<<HTML
            ...
            <title>{$safeTitle} — NeNe Deal デモ</title>
            <link rel="icon" href="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 42 42'%3E%3Crect width='42' height='42' fill='%23205e57'/%3E%3Ctext x='-2' y='32' font-family='sans-serif' font-weight='800' font-size='32' fill='%23ffffff' opacity='0.4'%3EN%3C/text%3E%3Ctext x='11' y='32' font-family='sans-serif' font-weight='800' font-size='32' fill='%23ffffff'%3EN%3C/text%3E%3C/svg%3E">
            <style>{$css}</style>
            </head>
            <body>
            ...
            {$reason}{$wait}{$actions}
                ...
                <div class="self">
                  ...
                  <div class="st"><b>待たずに、自分の環境で。</b> NeNe Deal はオープンソース（MIT）。自社サーバに置けば回数制限なくご利用いただけます。<a href="{$selfHostUrl}" rel="noopener">製品情報・セットアップを見る →</a></div>
                </div>
              </div>
              <div class="err-foot">
                <span>NeNe Deal — Deal Pipeline</span>
    ...
    /**
     * Deal's calm teal palette (hue ≈ 188, matching the SPA design tokens in
     * `frontend/src/app/design/styles.css`) over invoice's proven card layout —
    ...
    private function css(): string
    {
        return <<<'CSS'
            :root {
              --bg: oklch(98% 0.0025 190);
              --surface: oklch(100% 0 0);
              --surface-2: oklch(97.4% 0.0035 190);
              --surface-sunk: oklch(96.2% 0.004 190);
              --border: oklch(90.5% 0.006 190);
              --fg: oklch(27% 0.011 190);
              --fg-muted: oklch(50% 0.01 190);
              --fg-subtle: oklch(62% 0.008 190);
              --fg-faint: oklch(73% 0.007 190);
              --brand: oklch(43% 0.06 188);
              --brand-strong: oklch(36% 0.058 188);
              --brand-deep: oklch(29% 0.045 190);
              --brand-soft: oklch(93.5% 0.02 188);
              --brand-softer: oklch(97% 0.011 188);
              --on-brand: oklch(98.5% 0.006 188);
              --link: oklch(46% 0.055 215);
              --ok: oklch(47% 0.07 155);
              --warn: oklch(55% 0.075 75);
              --warn-soft: oklch(95% 0.035 80);
              --side-brand: oklch(93% 0.028 182);
              --shadow-pop: 0 8px 28px oklch(28% 0.03 190 / 0.16), 0 2px 6px oklch(28% 0.03 190 / 0.08);
            ...
            *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
            ...
            .et-name span { display: block; font-size: 10px; letter-spacing: .18em; text-transform: uppercase; color: oklch(82% 0.02 185); margin-top: 2px; }
